 ...
 */
	public static function checkSecurityKeys() {
		if (Configure::read('Security.salt') === 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi') {
			trigger_error('Por favor, cambie el valor de \'Security.salt\' en APP/Config/core.php. Para un valor \'Salt\' específico para su apliación.');
		}

		if (Configure::read('Security.cipherSeed') === '76859309657453542496749683645') {
			trigger_error('Por favor, cambie el valor de \'Security.cipherSeed\' en APP/Config/core.php a un valor númerico (solo dígitos) \'Seed Value\' específico para su aplicación.');
		}
	}
